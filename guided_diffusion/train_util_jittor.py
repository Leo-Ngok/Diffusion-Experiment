...
from . import dist_util_jittor, logger
from .fp16_util_jittor import MixedPrecisionTrainer
from .nn_jittor import update_ema
from .resample_jittor import LossAwareSampler, UniformSampler
...
class TrainLoop:
    ...
    def _load_and_sync_parameters(self):
        ...
        dist_util_jittor.sync_params(self.model.parameters())
    ...
    def _load_ema_parameters(self, rate):
        ...
        dist_util_jittor.sync_params(ema_params)
        return ema_params
    ...
    def forward_backward(self, batch, cond):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            t, weights = self.schedule_sampler.sample(micro.shape[0], None) #dist_util.dev())
    ...
    def preprocess_input(self, data):
        ...
        nc = self.num_classes
        input_label = jt.FloatTensor(bs, nc, h, w).zero_()
    ...
    def get_edges(self, t):
        edge = jt.ByteTensor(t.size()).zero_()
